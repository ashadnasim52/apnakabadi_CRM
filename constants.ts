...
export const INITIAL_ITEMS: ScrapItem[] = [
  ...
  { id: '22', name: 'Scrap Vehicle (Generic)', rate: 15, lastUpdated: getDate(0), category: 'Vehicle' },
  { id: '23', name: 'Car Scrap', rate: 15000, lastUpdated: getDate(0), category: 'Vehicle' },
  { id: '24', name: 'Bike Scrap', rate: 2500, lastUpdated: getDate(0), category: 'Vehicle' },
  { id: '25', name: 'Truck Scrap', rate: 45000, lastUpdated: getDate(0), category: 'Vehicle' },
  { id: '26', name: 'Bus Scrap', rate: 55000, lastUpdated: getDate(0), category: 'Vehicle' },
  { id: '27', name: 'Auto Rickshaw Scrap', rate: 5000, lastUpdated: getDate(0), category: 'Vehicle' },
...
export const INITIAL_BILLS: Bill[] = [
  ...
  {
    id: '104', billNo: 'PUR-V-001', transactionType: 'PURCHASE', customerName: 'Ashad', customerPhone: '08541866519', customerAddress: 'idrish colony kanta toli ranchi',
    date: getDateTime(1), paymentStatus: 'Paid', staffName: 'Ramesh Kumar', totalAmount: 15000, isFinalized: true,
    items: [
      { 
        id: 'b8', 
        itemId: '23', 
        ...
        amount: 15000,
        vehicleInfo: {
          vehicleName: 'Maruti Suzuki Alto',
          registrationNumber: 'JH01-BB-1234',
